 ...
 * Slug: mrclimb/activity-card-inverted
 * Categories: mrclimb
 */
?>
...
<div class="wp-block-group has-border-color has-mrclimb-decoration-background-color has-background" style="border-color:var(--wp--preset--color--mrclimb-element);border-width:5px;border-radius:8px;padding-top:0;padding-right:0;padding-bottom:0;padding-left:0">
    ...
    <div class="wp-block-columns">
        ...
        <div class="wp-block-column" style="flex-basis:60%">
            ...
            <figure class="wp-block-image size-large"><img src="<?php echo esc_url( get_template_directory_uri() ); ?>/assets/img/837328.jpg" alt="" style="aspect-ratio:3/2;object-fit:cover" /></figure>
            <!-- /wp:image -->
        </div>
        <!-- /wp:column -->
        ...
        <div class="wp-block-column has-white-color has-text-color" style="padding-top:var(--wp--preset--spacing--50);padding-right:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--50);padding-left:var(--wp--preset--spacing--40);flex-basis:40%">
            ...
            <p class="has-text-align-center"><?php echo esc_html__( 'Destination:', 'mrclimb' ); ?> <strong><?php echo esc_html__( 'Lorem Ipsum', 'mrclimb' ); ?></strong></p>
            <!-- /wp:paragraph -->

            <!-- wp:group {"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
            <div class="wp-block-group">
                <!-- wp:paragraph -->
                <p><?php echo esc_html__( 'Date:', 'mrclimb' ); ?> <strong><?php echo esc_html__( 'June 13, 2024', 'mrclimb' ); ?></strong></p>
                <!-- /wp:paragraph -->

                <!-- wp:paragraph -->
                <p><?php echo esc_html__( 'Hour:', 'mrclimb' ); ?> <strong><?php echo esc_html__( '5.30am', 'mrclimb' ); ?></strong></p>
                <!-- /wp:paragraph -->
            </div>
            <!-- /wp:group -->
