 ...
 * Slug: mrclimb/message-signature-inverted
 * Categories: mrclimb
 */
?>
        ...
        <div class="wp-block-cover__inner-container">
            ...
            <div class="wp-block-columns">
                ...
                <div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--80);padding-bottom:var(--wp--preset--spacing--80);flex-basis:66.66%">
                    ...
                    <h2 class="wp-block-heading has-text-align-center" style="padding-top:var(--wp--preset--spacing--40);padding-bottom:var(--wp--preset--spacing--40);font-size:4rem"><?php echo esc_html__( 'We provide excellence', 'mrclimb' ); ?></h2>
                    <!-- /wp:heading -->
