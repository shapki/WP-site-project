<?php
/**
 * Title: Opening hours, 3 columns
 * Slug: mrclimb/opening-hours
 * Categories: mrclimb
 */
?>
...
<div class="wp-block-group">
    ...
    <div class="wp-block-columns" style="padding-top:0;padding-bottom:0">
        ...
        <div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"textTransform":"uppercase"}},"textColor":"mrclimb-decoration"} -->
            <h4 class="wp-block-heading has-text-align-center has-mrclimb-decoration-color has-text-color" style="text-transform:uppercase"><?php echo esc_html__( 'Monday', 'mrclimb' ); ?></h4>
            <!-- /wp:heading -->
        ...
        <div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"textTransform":"uppercase"}},"textColor":"mrclimb-decoration"} -->
            <h4 class="wp-block-heading has-text-align-center has-mrclimb-decoration-color has-text-color" style="text-transform:uppercase"><?php echo esc_html__( 'Tuesday-Friday', 'mrclimb' ); ?></h4>
            <!-- /wp:heading -->
        ...
        <div class="wp-block-column" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)">
            <!-- wp:heading {"textAlign":"center","level":4,"style":{"typography":{"textTransform":"uppercase"}},"textColor":"mrclimb-decoration"} -->
            <h4 class="wp-block-heading has-text-align-center has-mrclimb-decoration-color has-text-color" style="text-transform:uppercase"><?php echo esc_html__( 'Saturday-Sunday', 'mrclimb' ); ?></h4>
            <!-- /wp:heading -->
