...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (($, Swal) => {
  ...
  const on_select_show = {
    post_redirect_to: {
      val: 'url',
      show_hide: 'post_redirect_to_link'
    },
    post_update_redirect_to: {
      val: 'url',
      show_hide: 'post_update_redirect_to_link'
    }
  };
      ...
      field_attrs.forEach(attrs => {
        ...
        if (openModalButton) {
          openModalButton.addEventListener('click', ev => {
            Swal.fire({
              'html': openModalButton.getAttribute('description'),
              'icon': 'info'
            });
          });
        }
...
/* harmony import */ var _admin_post_form__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./admin-post-form */ "./src/js/admin-post-form.js");
/**
 * Gutenberg Blocks
 *
...
(0,_admin_post_form__WEBPACK_IMPORTED_MODULE_1__["default"])(jQuery, (sweetalert2__WEBPACK_IMPORTED_MODULE_0___default()));
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _js_editor__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./js/editor */ "./src/js/editor.js");
